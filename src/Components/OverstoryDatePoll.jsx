        ...
        return (
            <Fragment>
                <header>
                    ...
                    <h1>Overstory Bookclub Date</h1>
                    <p>What are our options?</p>
                    <p className="note"><i>(Start time for all dates is 5 PM PST, 6 PM MST, 8 PM whatever time zone Spencer+Cassie are in.)</i></p>
                </header>
                <table>
                    <tr>
                        <th></th>
                        <th>May<br></br><span className="date">4</span><br></br>Tuesday</th>
                        <th>May<br></br><span className="date">5</span><br></br>Wednesday</th>
                        <th>May<br></br><span className="date">6</span><br></br>Thursday</th>
                        <th>May<br></br><span className="date">7</span><br></br>Friday</th>
                        <th>May<br></br><span className="date">1</span><br></br>Monday</th>
                    </tr>
                    <tr>
